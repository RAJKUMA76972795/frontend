    ...
    <div className={styles.betList}>
      <div className={styles.getStatement}>
        ...
        <div style={{ display: "flex", alignItems: "flex-end", height: "100%", justifyContent: "flex-end" }}>
          ...
          <button style={{ padding: "6px 12px", cursor: "pointer", borderRadius: "5px", border: "none", backgroundColor: "#14213D", fontSize: "14px", fontWeight: "600", color: "white" }}>Get Statement</button>
        </div>

      </div>


      <Heading heading="Account Statement" />
          ...
          <table className={styles.table}>
            <thead className={styles.thead}>
              <tr className={styles.tr}>
                ...
                <th className={styles.th}>Withdraw</th>
